                    ...
                    <div class="f_section">
                        <form id="profile" method="post" action="{{route('profile_update')}}" role="form" class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                               <select name="batch">
                                    ...
                                    <option {{$user->batch==$i?'selected="selected"':''}}  value="{{$i}}">{{$i}}</option>
                                    @endfor
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                              <select name="hall">
                                ...
                                @foreach(\Config::get('profile.hall') as $key => $value)
                                    <option {{$user->hall==$key?'selected="selected"':''}} value="{{$key}}">{{$value}}</option>
                                @endforeach
                                 <option value="others">others</option>
                              </select>
                            </div>
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                              <select name="department">
                                ...
                                @foreach(\Config::get('profile.department') as $key => $value)
                                    <option {{$user->department==$key?'selected="selected"':''}} value="{{$key}}">{{$value}}</option>
                                @endforeach
                                <option value="others">others</option>
                              </select>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">District:
                                <select name="present_address">
                                    <option selected disabled>Select One</option>
                                     @foreach(\Config::get('profile.district') as $key => $value)
                                        <option {{$user->present_address==$key?'selected="selected"':''}} value="{{$key}}">{{$value}}</option>
                                     @endforeach 
                                    <option value="others">others</option>
                                 </select>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                                <select class="form-control" id="three_chillah" name="three_chillah" value="{{ old('three_chillah') }}">
                                  <option {{$user->three_chillah=='1'?'selected="selected"':''}} value="1">Yes</option>
                                  <option {{$user->three_chillah=='0'?'selected="selected"':''}} value="0">No</option>
                                </select>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                                <select class="form-control" id="marital_status" name="marital_status" value="{{ old('marital_status') }}">
                                  <option {{$user->marital_status=='1'?'selected="selected"':''}} value="1">Single</option>
                                  <option {{$user->marital_status=='2'?'selected="selected"':''}} value="2">Married</option>
                                </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-8">
                                <select class="form-control" id="foreign_safar" name="foreign_safar" value="{{ old('foreign_safar') }}">
                                  <option {{$user->foreign_safar=='1'?'selected="selected"':''}} value="1">Yes</option>
                                  <option {{$user->foreign_safar=='0'?'selected="selected"':''}} value="0">No</option>
                                </select>
                            </div>
                          </div>
